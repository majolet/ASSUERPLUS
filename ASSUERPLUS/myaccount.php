        ...
        <div class="row">
          ...
          <div class="col-xxl-6 col-xl-5 col-lg-6 flex-column align-items-stretch justify-content-center py-5 px-lg-5 order-2 order-lg-1 ">
            ...
            <div class="onlineservices ">
              <div><a href="./test2.php" class="btn-get-started "><img src="./visuels/icons-accident.png" class="rounded mx-auto d-block" alt="..." height="32px" width="32px">déclarer un sinistre </a></div>
